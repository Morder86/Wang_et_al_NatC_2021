...
setwd("C:/Users/M181647/OneDrive - Mayo Clinic/Documents/GitHub/Wang_et_al_NatC_2021/GSE198014_RAW")
...
# This function emulates Read10X() for one GSM sample.
# read_geo_sample <- function(prefix, dir = "GSE198014_RAW") {
#   mtx <- readMM(gzfile(file.path(dir, paste0(prefix, "_matrix.mtx.gz"))))
#   features <- read.delim(
#     gzfile(file.path(dir, paste0(prefix, "_features.tsv.gz"))),
#     header = FALSE
#   )
#   barcodes <- read.delim(
#     gzfile(file.path(dir, paste0(prefix, "_barcodes.tsv.gz"))),
#     header = FALSE
#   )
#   
#   # Use V2 (gene symbol) but make unique
#   rownames(mtx) <- make.unique(features$V2)
...
# #Listing samples
# samples <- c(
#   "GSM5935857_IKKbCtrl_1",
#   "GSM5935858_IKKbCtrl_2",
#   "GSM5935859_IKKbWT_1",
#   "GSM5935860_IKKbWT_2",
#   "GSM5935861_IKKbCtrl_P301S+_1",
#   "GSM5935862_IKKbCtrl_P301S+_2",
#   "GSM5935863_IKKbWT_P301S+_1",
#   "GSM5935864_IKKbKO_P301S+_1",
#   "GSM5935865_IKKbKO_P301S+_2",
#   "GSM5935866_IKKbCA_P301S+_1",
#   "GSM5935867_IKKbCA_P301S+_2"
# )

#Loading all the samples
# seurat_list <- lapply(samples, read_geo_sample)

#for loading Cell Ranger counts:
LG343_80.counts <- Read10X("GSM5935857_IKKbCtrl_1")
...
#scaling the data
all <- ScaleData(all, features = VariableFeatures(all))
#perform and visualize PCA

all <- RunPCA(object = all, features = VariableFeatures(all), verbose = FALSE)
ElbowPlot(all)
...
ggplot(bcmvn_pbmc, aes(x=bcmvn_pbmc$pK, y=bcmvn_pbmc$BCmetric))+geom_bar(stat="identity")
dev.off()
...
nExp_poi <- as.integer (round(0.076*9629)) #estimate the number of multiplets you expect from the kit you are using - should give you percent expected based on number of nuclei inputs
...
# all <- doubletFinder(all, PCs = 1:10, pN = 0.25, pK = 0.005, nExp = nExp_poi.adj, reuse.pANN = "pANN_0.25_0.005_732", sct = FALSE)

#doublet finder with scDoubleFinder
library(scDblFinder)

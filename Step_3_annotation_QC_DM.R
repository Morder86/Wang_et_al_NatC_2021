...
setwd("C:/Users/m181647.MFAD/Documents/GitHub/Wang_et_al_NatC_2021/files")
...
Tau_integrated <- RenameIdents(Tau_integrated,
                                 ...
                                 `8`="excitatory neurons", `9`="inhibitory neurons", `10`="microglia", `11`="inhibitory neurons",
...
Tau_integrated <- RenameIdents(Tau_integrated,
                               `IKKbCtrl` = "ikbkb+/+", `IKKb_WT`="ikbkb+/+", `IKKbCtrl;P301S+`="ikbkb+/+;P301S+", `IKKbWT;P301S+`="ikbkb+/+;P301S+",
                               `IKKbKO;P301S+`="ikbkb-/-;P301S+", `IKKbCA;P301S+`="ikbkbCA;P301S+", `IKKbKO; Ctrl`="ikbkb+/+",
                               `IKKbKO; Cre/+; PS19/+`="ikbkb-/-;P301S+", `IKKbKO; Ctrl; PS19/+` = "ikbkb+/+;P301S+"
)
...
Tau_integrated <- RenameIdents(Tau_integrated,
                               `LG343_80` = "ikbkb+/+_1", `IKKbCtrl_2`="ikbkb+/+_2", `IKKb_WT_1`="ikbkb+/+_3", `IKKb_WT_2`="ikbkb+/+_4",
                               `LG343_107`="ikbkb+/+;P301S+_1", `IKKbCtrl;P301S+_2`="ikbkb+/+;P301S+_2",`IKKbWT;P301S+_1`="ikbkb+/+;P301S+_3",
                               `IKKbKO;P301S+_1`="ikbkb-/-;P301S+_1", `LG343_108`="ikbkb-/-;P301S+_2",
